...
function sharpResize(imgPath, newPath, width, height) {
    return __awaiter(this, void 0, void 0, function () {
        var resized;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, sharp_1.default)(imgPath)
                        .resize(width, height)
                        .toFile(newPath)
                        .then(function () {
...
;
exports.default = { checkFileExists: checkFileExists, sharpResize: sharpResize };
